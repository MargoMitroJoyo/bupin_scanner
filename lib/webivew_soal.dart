...
class WebviewSoal extends StatefulWidget {
  final String url;
  final String jenjang;
  final bool soalScan;
  final String cbtSdSmpSma;
  const WebviewSoal(this.url, this.jenjang, this.soalScan, this.cbtSdSmpSma,
      {super.key});

  @override
  State<WebviewSoal> createState() => _HalamanSoalState();
}

class _HalamanSoalState extends State<WebviewSoal>
