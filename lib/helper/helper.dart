...
static String extractBase64FromImgTag(String htmlString) {
  ...
  static Color localColor(String mapel) {
    ...
    if (mapel.toUpperCase().contains("BIOLOGI")) {
      return Color.fromARGB(255, 171, 124, 93);
    }
